...
const ProductRow = ({data = [], navigation, userInfo}) => {
  ...
  const productData = data?.length <= 10 ? data : data[0]?.product.slice(0, 10);
        ...
        <>
          <View style={styles.sectionTitleAndLinkWrapper}>
            ...
            <Link
              ...
              onPress={() =>
                navigation.navigate('SingleProductList', {
                  data: productList,
                  lable: 'Top Selling Product',
                  totalItems: page,
                })
              }
            />
